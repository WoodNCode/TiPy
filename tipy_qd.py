...
class TeeImSpeicher:
    """
    Leitet alle write()-Aufrufe sowohl an die Konsole als auch in einen StringIO-Puffer.
    """
...
def run_bemessung(
    ...
    """
    Führt die Berechnungen anhand der übergebenen Parameter aus und gibt alle Ausgaben als String zurück.
    """
    ...
    try:
        ...
        # -------------------------------------------------------------
        # 2) Lochleibungsfestigkeit bestimmen
        # -------------------------------------------------------------
        try:
            ...
            # Auswahl der zu verwendenden Festigkeit
            if auswahl == "0":
                f_h_k = f_h_0_k
        ...
        # -------------------------------------------------------------
        # 4) Berechnung der erforderlichen Holzdicke und Folgerechnung
        # -------------------------------------------------------------
...
if __name__ == "__main__":
    # Zum Testen lokal: Standardwerte übergeben
    output = run_bemessung(
        Holzart="Nadelholz",
        Vorbohrung="ja",
